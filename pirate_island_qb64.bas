...
$Resize:Stretch
$ExeIcon:'pirate.icns'
_Title "Pirate Island - John H. Doolittle (1989-1996)"
_Icon
' F1 About removed to avoid QB64 exit errors
Dim Shared appSupportPath$

appSupportPath$ = Environ$("HOME") + "/Library/Application Support/PirateIsland/"

' Create the save folder if it doesn't exist
If _DirExists(appSupportPath$) = 0 Then
    MKDIR appSupportPath$
    If _DirExists(appSupportPath$) = 0 Then
        Print "Warning: Could not create save folder at:"
...
Sub LOGON
    Shared ANSWER$()
    ReDim ANSWER$(305)
    Input "Enter your name: "; ANSWER$(0)
...
Sub EVALUATE
    ...
    Select Case VERB$
        ...
        Case "SAVE"
            ...
            saveFile$ = appSupportPath$ + "piresav.bas"
            ...
            For I = 1 To 5
                ...
                For J = 1 To Len(INVENTORY$(I))
                    DUMMY$ = DUMMY$ + Chr$(Asc(Mid$(INVENTORY$(I), J, 1)) + 4)
                Next J
                Write #1, DUMMY$
            Next I
            For I = 1 To NUMBERROOMS
                For J = 1 To 15
                    ...
                    For K = 1 To Len(ROOMOBJECT$(I, J))
                        DUMMY$ = DUMMY$ + Chr$(Asc(Mid$(ROOMOBJECT$(I, J), K, 1)) + 4)
                    Next K
                    Write #1, DUMMY$
                Next J
            Next I
        ...
        Case "RESTORE", "LOAD"
            ...
            saveFile$ = appSupportPath$ + "piresav.bas"
            If _FileExists(saveFile$) = 0 Then
                Print "No saved game found!": Exit Select
            End If
            ...
            For I = 1 To 5
                ...
                For J = 1 To Len(DUMMY$)
                    INVENTORY$(I) = INVENTORY$(I) + Chr$(Asc(Mid$(DUMMY$, J, 1)) - 4)
                Next J
            Next I
            ...
            For I = 1 To NUMBERROOMS
                For J = 1 To 15
                    ...
                    For K = 1 To Len(DUMMY$)
                        ROOMOBJECT$(I, J) = ROOMOBJECT$(I, J) + Chr$(Asc(Mid$(DUMMY$, K, 1)) - 4)
                    Next K
                Next J
            Next I
...
Sub CLOSING
    ...
    dataFile$ = appSupportPath$ + "pirtdata.txt"
    ...
    ' Show About box directly
    CLS
    PRINT "=== PIRATE ISLAND ==="
    PRINT
    PRINT "Original game by John H. Doolittle (1989-1996)"
    PRINT "Source released 2023 via IFArchive"
    PRINT
    PRINT "QB64 macOS Port by JRay (M-Endymion)"
    PRINT "https://github.com/M-Endymion/pirate-island-mac-port"
    PRINT
